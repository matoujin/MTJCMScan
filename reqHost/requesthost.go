...
func SetClient(host string) (resp *http.Response, err error) {
	client := &http.Client{}

	req, _ := http.NewRequest("GET", host, nil)
	req.Header.Add("User_Agent", GetRandomUa())
	if err != nil {
		return nil, err
	}
...
func BodyReq(host string) (content []byte, err error) {

	resp, err := SetClient(host)
	if err != nil {
		return nil, err
	}
...
func HeadersReq(host string) (*ResponseStruct, error) {
